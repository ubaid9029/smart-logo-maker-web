...
export default async function Signup({ searchParams }: Props) {
  ...
  return (
    <AuthShell alignment="right" imagePosition="left">
      <div className="flex w-full max-w-[1180px] justify-end">
        <div className="z-10 w-full max-w-md rounded-3xl bg-white/85 px-6 py-5 shadow-[0_18px_55px_rgba(0,0,0,0.14)] backdrop-blur-xl md:mr-16 lg:mr-20">
