...
import { DEFAULT_EDITOR_FONT_FAMILY, EDITOR_FONT_CATALOG } from '../../lib/editorFonts';

export const EDITOR_FONT_FAMILIES = {
  "1": DEFAULT_EDITOR_FONT_FAMILY,
  "2": "Bebas Neue",
  "3": "Abril Fatface",
  "4": "Cinzel",
  "5": "IBM Plex Mono",
...
export const AVAILABLE_EDITOR_FONTS = EDITOR_FONT_CATALOG;
